...
export default function Home() {
  ...
  const heroViews = [
    ...
    { src: "/uma-mini-group.jpg", alt: "Wide view of multiple connected UMA Mini lanterns", label: "Connected" },
  ];
  ...
  return (
    <main>
      ...
      <section className={`hero ${heroVersion > 0 ? "hero-wide" : ""}`} id="top">
        <img src={heroViews[heroVersion].src} alt={heroViews[heroVersion].alt} onError={(event) => { event.currentTarget.src = heroVersion === 1 ? "/uma-mini-hero.jpg" : "/uma-original-product.jpg"; }} /><div className="hero-shade" />
      ...
      <section className="split" id="sound">
        <div className="split-image"><img src="/uma-mini-detail.jpg" alt="Details and controls of the UMA Mini sound lantern" /></div>
      ...
      <section className="connected"><div className="connected-copy"><p className="eyebrow">Connected atmosphere</p><h2><span>One light becomes a moment.</span><span>Many transform the room.</span></h2><p>UMA Mini Party Mode connects up to 24 units to one source—creating a field of synchronised sound and warm, portable light.</p></div><img src="/uma-mini-group.jpg" alt="Multiple UMA Mini lanterns arranged together" /></section>
