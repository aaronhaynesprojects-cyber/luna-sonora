...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="connected"><div className="connected-copy"><p className="eyebrow">Connected atmosphere</p><h2>One light becomes a moment.<br />Many transform the room.</h2><p>UMA Mini Party Mode connects up to 24 units to one source—creating a field of synchronised sound and warm, portable light.</p></div><img src="/uma-mini-group.jpg" alt="Multiple UMA Mini lanterns arranged together" /></section>
